...
In the postings list, title zone or abstract zone of the patent document are stored as separate documents
and have separate counts of raw term frequency.
